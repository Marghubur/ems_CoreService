...
namespace ServiceLayer.Interface
{
    public interface ILeaveRequestService
    {
        ...
        Task<List<LeaveRequestNotification>> ConfigPayrollApproveAppliedLeaveService(LeaveRequestDetail leaveRequestDetail);
        Task<List<LeaveRequestNotification>> ConfigPayrollCancelAppliedLeaveService(LeaveRequestDetail leaveRequestDetail);
    }
}
